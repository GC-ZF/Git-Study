...
> Q：为什么最后分支图会分叉？
>
> A：新分支都是继承`master`分支"主管提交"这条记录。`zhang`分支的记录前进到"小张提交"，而`wang`分支只是在"主管提交"这条记录的基础上修改，所以也是在"主管提交"之后。`zhang`分支合并时没有冲突但合并`wang`分支时本应该链接"主管提交"之后，但是"主管提交"之后现在链接"小张提交"，所以会有分叉
...
>前面学习了`git merge`，作用是为了合并分支，了解到`git merge`会使日志变得混乱。`git rebase`也是合并分支的作用，但所谓"变基"，就是改变他们的"基"，将日志整理为一条直线
...
> GitHub中有很多很多的功能，只不过是英文，所以大家回避去探索它，这里只说一了些实用的或者可能用到的一些按钮。自己可以多点点，多探索探索。顺便提一嘴自己在csdn搜一下**Github网站镜像、Git克隆镜像、cdn.jsdelivr.net快速访问仓库文件**，解决404的烦恼！

# 十六、总结

> 到这里，本专栏就结束啦！初学建议使用**Gitee**练手，因为**Github**一方面被ban了，一方面全英文，先使用**Gitee**网页熟悉页面，**Github**和**Gitee**页面布局大同小异

仓库规则：[Gitee 配额](https://gitee.com/help/articles/4283#article-header0)，[Github配额](https://github.com/account/upgrade?plan=pro&source=account+compare+plans)。企业版自己看吧，大家都是个人估计也用不到
...
> 专栏速览：
>
> 1. [Git使用 从入门到入土 收藏吃灰系列(一) 专栏前言](https://blog.csdn.net/qq_49488584/article/details/122691262)
> 2. [Git使用 从入门到入土 收藏吃灰系列(二) Git的安装与配置](https://blog.csdn.net/qq_49488584/article/details/122698580)
> 3. [Git使用 从入门到入土 收藏吃灰系列(三) Git常用命令](https://blog.csdn.net/qq_49488584/article/details/122775246)
> 4. [Git使用 从入门到入土 收藏吃灰系列(四) Git工作原理](https://blog.csdn.net/qq_49488584/article/details/122785898)
> 5. [Git使用 从入门到入土 收藏吃灰系列(五) Git本地仓库搭建](https://blog.csdn.net/qq_49488584/article/details/122816025)
> 6. [Git使用 从入门到入土 收藏吃灰系列(六) 链接远程仓库](https://blog.csdn.net/qq_49488584/article/details/122830353)
> 7. [Git使用 从入门到入土 收藏吃灰系列 (七) 同时配置Gitee、Github 公钥](https://blog.csdn.net/qq_49488584/article/details/122847554)
> 8. [Git使用 从入门到入土 收藏吃灰系列 (八) 什么是分支 分支的作用](https://blog.csdn.net/qq_49488584/article/details/122857478)
> 9. [Git使用 从入门到入土 收藏吃灰系列 (九) git reset 移除暂存区与版本回退](https://blog.csdn.net/qq_49488584/article/details/122880287)
> 10. [Git使用 从入门到入土 收藏吃灰系列 (十) 详谈push、fetch、pull](https://blog.csdn.net/qq_49488584/article/details/122906704)
> 11. [Git使用 从入门到入土 收藏吃灰系列 (十一) 下载所有远程仓库分支](https://blog.csdn.net/qq_49488584/article/details/122932198)
> 12. [Git使用 从入门到入土 收藏吃灰系列 (十二) git merge 与 git rebase](https://blog.csdn.net/qq_49488584/article/details/122938572)
> 13. [Git使用 从入门到入土 收藏吃灰系列 (十三) git stash、git check-pick、git tag、git diff](https://blog.csdn.net/qq_49488584/article/details/122966614)
> 14. [Git使用 从入门到入土 收藏吃灰系列 (十四) 清除git仓库的所有提交记录](https://blog.csdn.net/qq_49488584/article/details/122979816)
> 15. [Git使用 从入门到入土 收藏吃灰系列 (十五) 自定义Git命令](https://blog.csdn.net/qq_49488584/article/details/123000553)
> 16. [Git使用 (十六) Github上的小按钮](https://blog.csdn.net/qq_49488584/article/details/123016332)
> 17. [Git使用 (十七) 解决Git Bash中文乱码](https://blog.csdn.net/qq_49488584/article/details/123027936)
